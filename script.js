...
async function enableCam() {
    ...
    // If turning predictions off, stop the video stream and remove event listener
...
async function predictWebcam() {
  ...
  if (lastVideoTime !== video.currentTime) {
    ...
    results = await handLandmarker.detectForVideo(video, startTimeMs); // await the promise
  }
